...
case 20:
        ...
        %>
        <jsp:useBean id="com1model1Person_2id" scope="session" class="com.model.Person" />
        <%
        com1model1Person_2id.setAge(age_3idTemp);
        com1model1Person_2id.setName(name_4idTemp);
        com1model1Person_2id.setId(id_5idTemp);
        boolean addPerson20mtemp = samplePersonServiceImplProxyid.addPerson(com1model1Person_2id);
...
case 31:
        gotMethod = true;
        com.model.Person[] getAllPersons31mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
case 34:
        ...
        com.model.Person getPerson34mtemp = samplePersonServiceImplProxyid.getPerson(id_6idTemp);
